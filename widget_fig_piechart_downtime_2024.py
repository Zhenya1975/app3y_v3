...
def fig_piechart_downtime_2024(theme_selector):  
  downtime_by_categiries_2024 = pd.read_csv('widget_data/downtime_by_categiries_2024_data.csv')
  
  labels = list(downtime_by_categiries_2024['Вид ТОРО'])
  values = list(downtime_by_categiries_2024['Простой, час'])
  if theme_selector:
